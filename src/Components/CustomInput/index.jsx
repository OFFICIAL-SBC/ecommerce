        ...
        return(
            ...
            <div className={styleDiv}>
                    ...
                    <label htmlFor={inputName} className={`relative`}>
                        ...
                        <span className="absolute left-3 top-3 px-1 text-base tracking-wide peer-focus:text-indigo-600 pointer-events-none duration-200 peer-focus:text-sm peer-focus:-translate-y-6 bg-white">{textLabel.charAt(0).toUpperCase() + textLabel.slice(1)}</span>
                    </label>
            </div>
        );
}
